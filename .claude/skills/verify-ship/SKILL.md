...
Checklist in `.claude/docs/coding-standards.md` and the constraints in
...
| 5 | No overflow | At the studio mobile baseline (390×844, per `.claude/docs/technical-preferences.md`), `scrollWidth <= clientWidth` | no |
