...
| `browser-game-specialist` | Browser implementation | Sonnet | All HTML/CSS/JS — game loops, rendering, input, audio, mobile browser |
| `ai-programmer` | AI systems | Sonnet | Behavior trees, pathfinding, NPC logic, state machines |
| `tools-programmer` | Dev tools | Sonnet | Pipeline tools, debug utilities, dev scripts |
...
| Agent | Domain | Model | When to Use |
|-------|--------|-------|-------------|
| `browser-game-specialist` | Browser games | Sonnet | All HTML/CSS/JS implementation — game loops, DOM/Canvas rendering, input (keyboard + touch), Web Audio API, localStorage, mobile browser support (iOS Safari + Android Chrome) |
